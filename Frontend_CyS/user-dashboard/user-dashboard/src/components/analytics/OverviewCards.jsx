...
const overviewData = [
	{ name: "Total Threats Detected", value: "1258", change: 12.5, icon: DollarSign },
	{ name: "Compromised", value: "16", change: 8.3, icon: Users },
	{ name: "Attacks Blocked", value: "1110", change: -3.2, icon: ShoppingBag },
	{ name: "Suspicious Activities", value: "1258", change: 15.7, icon: Eye },
];
